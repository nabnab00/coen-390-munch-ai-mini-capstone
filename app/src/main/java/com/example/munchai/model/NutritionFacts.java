...
public class NutritionFacts
{
    ...
    @JsonProperty("total_carbohydrate_g")
    public Double totalCarbG;

    @JsonProperty("dietary_fiber_g")
    public Double fiberG;

    @JsonProperty("sugars_g")
    public Double sugarsG;

    @JsonProperty("protein_g")
    public Double proteinG;

    @JsonProperty("vitamin_a_percent")
    public Double vitaminAPercent;

    @JsonProperty("vitamin_b_percent")
    public Double vitaminBPercent;

    @JsonProperty("vitamin_c_percent")
    public Double vitaminCPercent;
